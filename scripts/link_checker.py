...
使い方:
    ...
    python scripts/link_checker.py src/content/posts/ppt-pyramid-principle.mdx
...
USER_AGENT = (
    "Mozilla/5.0 (compatible; ConsulDeckLab-LinkChecker/1.0; "
    "+https://consul-deck-lab.com)"
)
TIMEOUT = 10
